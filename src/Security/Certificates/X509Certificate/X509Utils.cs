...
using CryptoHives.Foundation.Security.Certificates.X509Crl;
using System;
...
public static partial class X509Utils
{
    ...
    public static bool CompareDistinguishedName(X500DistinguishedName name1, X500DistinguishedName name2)
    {
        ...
        return name1.RawData.AsSpan().SequenceEqual(name2.RawData.AsSpan());
    }
    ...
    private static readonly char[] _anyOf = new char[] { '/', ',', '=' };
