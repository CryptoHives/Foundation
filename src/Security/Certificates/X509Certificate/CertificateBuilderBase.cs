...
#endif
{
    ...
    protected CertificateBuilderBase(X500DistinguishedName subjectName)
    {
        ...
        _serialNumber = Array.Empty<byte>();
        _notBefore = DateTime.UtcNow.AddDays(-1).Date;
        _notAfter = _notBefore.AddMonths(X509Defaults.LifeTime);
    ...
    /// Initialize a Certificate builder.
    /// </summary>
    protected CertificateBuilderBase(string subjectName) : this(new X500DistinguishedName(subjectName))
    {
    }
    #endregion
