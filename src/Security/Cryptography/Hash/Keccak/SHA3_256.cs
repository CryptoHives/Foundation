...
public sealed class SHA3_256 : KeccakHashCore
{
    ...
    /// <summary>
    /// Gets the SIMD instruction sets supported by SHA3-256 on the current platform.
    /// </summary>
...
#if NET8_0_OR_GREATER
            if (System.Security.Cryptography.SHA3_256.IsSupported) support |= SimdSupport.Os;
#endif
            return support;
        }
    }
