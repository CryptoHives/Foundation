...
public sealed class TurboShake128 : KeccakXofCore
{
    ...
    public TurboShake128(int outputBytes) : this(KeccakDefault, outputBytes)
    {
    }
    ...
    public TurboShake128(int outputBytes, byte domainSeparator) : this(KeccakDefault, outputBytes, domainSeparator)
    {
    }
