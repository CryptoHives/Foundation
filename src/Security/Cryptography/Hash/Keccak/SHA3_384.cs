...
/// <remarks>
/// <para>
/// This is a fully managed implementation of SHA3-384 based on the Keccak sponge
...
public sealed class SHA3_384 : KeccakCore
{
    ...
    /// <summary>
    /// The rate in bytes (832 bits for SHA3-384).
    /// </summary>
    ...
    /// </summary>
    public const int CapacityBytes = 96;
    ...
    /// </summary>
    public SHA3_384() : this(SimdSupport.KeccakDefault)
    {
    }
    ...
    internal SHA3_384(SimdSupport simdSupport) : base(RateBytes, simdSupport)
    {
    ...
    /// <inheritdoc/>
    public override string AlgorithmName => "SHA3-384";

    /// <inheritdoc/>
    public override int BlockSize => RateBytes;

    /// <summary>
    /// Creates a new instance of the <see cref="SHA3_384"/> class.
    /// </summary>
    /// <returns>A new SHA3-384 hash algorithm instance.</returns>
    public static new SHA3_384 Create() => new();

    /// <summary>
    /// Creates a new instance of the <see cref="SHA3_384"/> class with specified SIMD support.
    /// </summary>
