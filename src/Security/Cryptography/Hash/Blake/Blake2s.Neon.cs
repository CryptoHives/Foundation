...
internal unsafe partial struct Blake2sState
{
    ...
    /// <summary>
    /// Diagonal permutation. Call as <c>PermuteNeon(ref row0, ref row2, ref row3)</c> to
    /// diagonalize and <c>PermuteNeon(ref row2, ref row0, ref row3)</c> to un-diagonalize.
    /// </summary>
    [MethodImpl(MethodImplOptionsEx.HotPath)]
    private static void PermuteNeon(
        ref Vector128<uint> by3, ref Vector128<uint> by1, ref Vector128<uint> by2)
    {
        by3 = AdvSimd.ExtractVector128(by3.AsByte(), by3.AsByte(), 12).AsUInt32();
        by1 = AdvSimd.ExtractVector128(by1.AsByte(), by1.AsByte(), 4).AsUInt32();
        by2 = AdvSimd.ExtractVector128(by2.AsByte(), by2.AsByte(), 8).AsUInt32();
    }
}
