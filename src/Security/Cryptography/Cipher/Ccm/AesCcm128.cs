...
public sealed class AesCcm128 : AesCcm
{
    ...
    public AesCcm128(ReadOnlySpan<byte> key) : this(AesCore.AesDefault, key)
    {
    }
    ...
    /// <param name="key">The 16-byte key.</param>
    internal AesCcm128(SimdSupport simdSupport, ReadOnlySpan<byte> key) : base(simdSupport, key)
    {
    ...
    public static AesCcm128 Create(ReadOnlySpan<byte> key) => new(key);
    ...
    /// <param name="key">The 16-byte key.</param>
    /// <returns>A new AES-128-CCM instance.</returns>
    internal static AesCcm128 Create(SimdSupport simdSupport, ReadOnlySpan<byte> key) => new(simdSupport, key);
}
