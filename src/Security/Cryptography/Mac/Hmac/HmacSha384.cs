...
/// <remarks>
/// <para>
/// This is a fully managed implementation of HMAC-SHA-384 as defined in RFC 2104,
/// using the CryptoHives SHA-384 implementation. It does not rely on OS or hardware
...
/// </para>
/// </remarks>
public sealed class HmacSha384 : HmacCore
{
    /// <summary>
    ...
    public HmacSha384(byte[] key)
        : base("HMAC-SHA384", SHA384.Create(), SHA384.Create(), key)
    {
    }

    /// <summary>
    /// Creates a new instance of the <see cref="HmacSha384"/> class.
    /// </summary>
    /// <param name="key">The secret key.</param>
    /// <returns>A new HMAC-SHA-384 instance.</returns>
    public static HmacSha384 Create(byte[] key) => new(key);
