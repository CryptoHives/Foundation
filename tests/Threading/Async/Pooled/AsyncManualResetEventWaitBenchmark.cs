...
/// <summary>
/// Benchmarks measuring async wait performance on ManualResetEvent implementations.
/// </summary>
/// <remarks>
/// <para>
/// This benchmark suite evaluates the performance of waiting on a manual-reset event
...
public class AsyncManualResetEventWaitBenchmark : AsyncManualResetEventBaseBenchmark
{
    /// <summary>
    /// Benchmark for pooled async manual-reset event using Task (converted from ValueTask).
    /// </summary>
    /// <remarks>
    ...
    public async Task PooledAsyncManualResetEventTaskWaitAsync(CancellationType cancellationType)
    {
    ...
    /// <summary>
    /// Benchmark for pooled async manual-reset event using ValueTask directly.
    /// </summary>
    /// <remarks>
    ...
    [TestCaseSource(typeof(CancellationType), nameof(CancellationType.NoneNotCancelledGroup))]
    [ArgumentsSource(typeof(CancellationType), nameof(CancellationType.NoneNotCancelledGroup))]
    public async Task PooledAsyncManualResetEventValueTaskWaitAsync(CancellationType cancellationType)
    {
        ValueTask vt = _eventPooled!.WaitAsync(cancellationType.CancellationToken);
        _eventPooled.Set();
...
#if !SIGNASSEMBLY
    /// <summary>
    /// Benchmark for Nito.AsyncEx async manual-reset event.
    /// </summary>
    /// <remarks>
    ...
    [TestCaseSource(typeof(CancellationType), nameof(CancellationType.NoneNotCancelledGroup))]
    [ArgumentsSource(typeof(CancellationType), nameof(CancellationType.NoneNotCancelledGroup))]
    public async Task NitoAsyncManualResetEventTaskWaitAsync(CancellationType cancellationType)
    {
    ...
    /// <summary>
    /// Benchmark for reference implementation async manual-reset event (baseline).
    /// </summary>
    /// <remarks>
    ...
    public async Task RefImplAsyncManualResetEventTaskWaitAsync(CancellationType cancellationType)
    {
