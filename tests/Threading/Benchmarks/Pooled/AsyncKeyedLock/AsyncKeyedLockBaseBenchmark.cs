...
public abstract class AsyncKeyedLockBaseBenchmark
{
    ...
    private protected global::AsyncKeyedLock.AsyncKeyedLocker<string> _lockThirdParty;
    private protected global::AsyncKeyedLock.StripedAsyncKeyedLocker<string> _lockStriped;
#if !NETFRAMEWORK
