...
public class KeyEncodingTests
{
    ...
    public void Ed25519SpkiInteropWithBouncyCastle()
    {
        ...
        var bcPub = Org.BouncyCastle.Security.PublicKeyFactory.CreateKey(spki)
            as Org.BouncyCastle.Crypto.Parameters.Ed25519PublicKeyParameters;
    ...
    public void Ed25519Pkcs8InteropWithBouncyCastle()
    {
        ...
        var bcPriv = Org.BouncyCastle.Security.PrivateKeyFactory.CreateKey(pkcs8)
            as Org.BouncyCastle.Crypto.Parameters.Ed25519PrivateKeyParameters;
